...
image_new = pd.read_csv("cleaned_final.csv")
image_unique = image_new.drop_duplicates("ActorName")
image_unique.ActorName = image_unique.ActorName.str.replace(' ', '')
female = image_unique[image_unique.Gender == "Female"]
male = image_unique[image_unique.Gender == "Male"]
halfF = female['ActorName'].values
namefileF = ['/Users/valencialie/Desktop/CZ1016_DS2/kdrama/Facial Similarity/Images/Female' + i for i in halfF +".jpeg"]
 newF = ['/Users/valencialie/Desktop/CZ1016_DS2/kdrama/Images/Female/' + i for i in halfF +".jpeg"]
halfM = male['ActorName'].values
namefileM = ['/Users/valencialie/Desktop/CZ1016_DS2/kdrama/Facial Similarity/Images/Male' + i for i in halfM +".jpeg"]
